...
export const gameItems: GameItem[] = [
  ...
  },
  {
    ...
    value: 47200,
    maxStack: 1,
    description: "Heavy armor vest with strong protection and reduced mobility.",
    tags: ["armor", "vest"],
  ...
  },
  {
    ...
    value: 900,
    maxStack: 10,
    description: "Common crafting material used for electronics and upgrades.",
    tags: ["crafting", "electronics"],
  },
  {
  ...
  },
  {
    ...
    value: 7200,
    maxStack: 1,
    description: "Upgrade part for ventilation, cooling and grow room systems.",
    tags: ["upgrade", "ventilation"],
  },
  {
    id: "part_water_pump",
    name: "Water Pump",
    ...
    value: 12600,
    maxStack: 1,
    description: "Upgrade part used for irrigation and water system modules.",
    tags: ["upgrade", "water"],
  },
  {
